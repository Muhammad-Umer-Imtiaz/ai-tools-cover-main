            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div>
                ...
                <p className="text-gray-700 text-sm sm:text-base font-medium mb-6 sm:mb-8 leading-relaxed">
                  We continuously seek the newest and most innovative AI tools
                  to enhance our directory.
                </p>
              </div>
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div>
                ...
                <p className="text-purple-100 text-sm sm:text-base font-medium mb-6 sm:mb-8 leading-relaxed">
                  We explore the internet and social media platforms to list AI
                  tools, so we&apos;ll likely find and feature yours.
                </p>
              </div>
              ...
              <div>
                <ul className="space-y-3">
                  {categories.slice(0, 9).map((tool) => (
                    <li key={tool.label}>
                      <Link href={`/category/${slugify(tool.label)}`}>
...
function StartupFame() {
  return (
    <a
      href="https://startupfa.me/s/ai-tools-cover?utm_source=aitoolscover.com"
      target="_blank"
    >
      <img
    ...
    <div className="border-t border-gray-200 bg-white rounded-lg shadow-sm p-6 mt-8">
      <div className="text-center text-gray-700 text-sm">
        ...
        <div className="flex justify-center items-center space-x-6 text-xs">
          <Link
            href="/privacy-policy"
            className="hover:text-purple-600 cursor-pointer transition-colors duration-200 hover:underline"
          >
            Privacy Policy
          </Link>
