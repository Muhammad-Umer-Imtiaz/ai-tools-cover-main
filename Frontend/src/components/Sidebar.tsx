      ...
      >
        ...
        <div className="sidebar-header px-4 pt-4 bg-white">
          <div className="flex items-center justify-between">
            {!isCollapsed && <h2 className="text-[#7d42fb] font-bold text-lg">Categories</h2>}
            <button
        ...
        <div className="flex-1 overflow-y-auto py-4 px-2 space-y-2">
          {categories.map(({ label, emoji }, index) => (
            ...
            >
              ...
              <span
                className={`relative z-10 ${isCollapsed ? 'sr-only lg:not-sr-only lg:text-xs lg:text-center lg:block' : ''}`}
              >
