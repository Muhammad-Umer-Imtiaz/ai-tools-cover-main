...
export const categories = [
  // { label: 'Personal Assitant', slug: 'personal-assistant', emoji: '👤' },
  // { label: 'Research', slug: 'research', emoji: '🔍' },
  // { label: 'Spreadsheet', slug: 'spreadsheet', emoji: '📊' },
  { label: 'Presentations', slug: 'presentations', emoji: '📽️' },
  { label: 'Website Builders', slug: 'website-builders', emoji: '🌐' },
  { label: 'Marketing', slug: 'marketing', emoji: '📢' },
  { label: 'Social Media', slug: 'social-media', emoji: '💬' },
  { label: 'Project Management', slug: 'project-management', emoji: '📅' },
  { label: 'Video Editing', slug: 'video-editing', emoji: '🎬' },
  { label: 'Video Generators', slug: 'video-generators', emoji: '📹' },
  { label: 'Prompt Generators', slug: 'prompt-generators', emoji: '💡' },
  { label: 'Writing Generators', slug: 'writing-generators', emoji: '✍️' },
  // { label: 'Email Generators', slug: 'email-generators', emoji: '📧' },
  { label: 'Design Generators', slug: 'design-generators', emoji: '🎨' },
  { label: 'Image Generators', slug: 'image-generators', emoji: '🖼️' },
  { label: 'Workflows', slug: 'workflows', emoji: '⚙️' },
  { label: 'Ai Agents', slug: 'ai-agents', emoji: '🤖' },
  { label: 'Cartoon Generators', slug: 'cartoon-generators', emoji: '🎭' },
  { label: 'Portrait Generators', slug: 'portrait-generators', emoji: '🖌️' },
  { label: 'Audio Editing', slug: 'audio-editing', emoji: '🎵' },
  { label: 'Text To Speech', slug: 'text-to-speech', emoji: '🗣️' },
  { label: 'Code Assistant', slug: 'code-assistant', emoji: '💻' },
